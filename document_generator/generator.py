...
def create_documents(job_data, tailored_docs_latex, target_output_directory):
    ...
    resume_pdf_path = compile_latex_to_pdf(populated_resume_tex, target_dir, "Resume")
    cover_letter_pdf_path = compile_latex_to_pdf(populated_cl_tex, target_dir, "CoverLetter") if populated_cl_tex else None
    job_details_pdf_path = create_job_details_pdf_reportlab(job_data, target_dir)
